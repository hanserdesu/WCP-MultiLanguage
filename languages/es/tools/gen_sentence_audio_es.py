# -*- coding: utf-8 -*-
"""Batch generate Spanish sentence audio -> es_sentence_audio/md5(es).mp3
Voice: es-ES-ElviraNeural. md5(es) mirrors Japanese/French convention.
"""
import argparse, asyncio, hashlib, json, os, random, re, sys, time
from pathlib import Path
import edge_tts
from audio_paths_es import sentence_audio_dir

sys.stdout.reconfigure(encoding='utf-8')
ROOT = Path(__file__).resolve().parent.parent
SENT_DIR = sentence_audio_dir()
MANIFEST = ROOT / 'output' / 'audio_manifest_es_sent.json'
