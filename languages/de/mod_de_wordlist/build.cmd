@echo off
rem Build WCP DE Word List plugin (BepInEx 5, C#5 via NETFX csc)
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ /codepage:65001 %REFS% ^
 /out:"%~dp0DeWordListMod.dll" "%~dp0DeWordListMod.cs" "%~dp0..\mod_book_name\BookProfiles.cs"
...
copy /y "%~dp0DeWordListMod.dll" "%GAME%\BepInEx\plugins\DeWordListMod.dll" >nul
if errorlevel 1 (
