...
// 例句旁挂 ▶ 按钮, 点击播放 fr_sentence_audio/<md5(fr)>.mp3 (由
...
namespace SentenceAudioFr
{
    ...
    public class FrSentenceAudioPlugin : BaseUnityPlugin
    {
        ...
        private const string AudioDirName = "fr_sentence_audio";
        ...
        void Awake()
        {
            ...
            Log.LogInfo(string.Format(
                "WCP Sentence Audio FR 1.0.0 loaded, audio dir = {0}", _audioDir));
        }
