@echo off
rem Build WCP Sentence Audio FR plugin (BepInEx 5, C#5 via NETFX csc)
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ %REFS% ^
 /out:"%~dp0SentenceAudioFrMod.dll" "%~dp0SentenceAudioFrMod.cs" "%~dp0..\mod_book_name\BookProfiles.cs"
...
copy /y "%~dp0SentenceAudioFrMod.dll" "%GAME%\BepInEx\plugins\SentenceAudioFrMod.dll" >nul
if errorlevel 1 (
