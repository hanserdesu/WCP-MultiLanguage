@echo off
rem Build WCP FR Word List plugin (BepInEx 5, C#5 via NETFX csc)
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ /codepage:65001 %REFS% ^
 /out:"%~dp0FrWordListMod.dll" "%~dp0FrWordListMod.cs" "%~dp0..\mod_book_name\BookProfiles.cs"
...
copy /y "%~dp0FrWordListMod.dll" "%GAME%\BepInEx\plugins\FrWordListMod.dll" >nul
if errorlevel 1 (
