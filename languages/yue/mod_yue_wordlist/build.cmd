@echo off
rem Build WCP YUE (Cantonese) Word List plugin (BepInEx 5, C#5 via NETFX csc)
...
"%CSC%" /nologo /noconfig /nostdlib+ /target:library /langversion:5 /optimize+ /codepage:65001 %REFS% ^
 /out:"%~dp0YueWordListMod.dll" "%~dp0YueWordListMod.cs" "%~dp0..\mod_book_name\BookProfiles.cs"
...
copy /y "%~dp0YueWordListMod.dll" "%GAME%\BepInEx\plugins\YueWordListMod.dll" >nul
if errorlevel 1 (
